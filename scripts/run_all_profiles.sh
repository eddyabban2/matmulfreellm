...
# python auto_profiler.py -s 1000 --max_new_tokens 2 --min_batch_power 0 --max_batch_power 0 --model_name scaled_bitnet 2>&1 | tee log11.log
python auto_profiler.py -s 1000 --max_new_tokens 2 --min_batch_power 5 --max_batch_power 5 --model_name scaled_bitnet 2>&1 | tee log12.log
