...
do
    ...
    # /opt/nvidia/nsight-compute/2025.1.1/target/linux-desktop-glibc_2_11_3-x64/ncu --config-file off --export /home/eabban/atten_ncu/batchsize$batch_size --force-overwrite --set detailed /home/eabban/eddy_matmulfreellm/attention_only.py -b $batch_size
